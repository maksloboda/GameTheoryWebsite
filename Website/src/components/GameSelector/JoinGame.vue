  ...
  <div class="container mt-4">
    <b-card>
      <b-row>
        ...
        <b-col sm="3">
          <b-button @click="getLobbies()" variant="success" class="w-100">{{ $t('message.JoinGame.Refresh') }}
          </b-button>
        </b-col>
      </b-row>
    </b-card>
...
import Fool from "../GameData/SingleSuit/Fool"
import Whistette from "../GameData/SingleSuit/Whistette"
...
export default {
  ...
  methods: {
    ...
    makeGameStateString(string_state, game_name) {
      ...
      } else if (game_name === Fool.getInternalGameName()) {
