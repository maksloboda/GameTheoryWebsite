export const messages = {
    en: {
      message: {
        ...
        PlayGame: {
            ...
            CanPass: 'can pass',
            Start: 'Start:',
            StartPrivate: 'Create private game',
            StartPublic: 'Create public game',
            Loading: 'Loading...',
            MakeMove: 'Make move',
    ...
    ru: {
      message: {
        ...
        SekiInfo: {
          ...
          option1: 'Игра Секи: сделавший ход последним - выигрывает.',
          option2: 'Игра Н-Секи: вышеуказанная ситуация является ничьей.',
    ...
    \
        ...
        SingleSuitInfo: {
          ...
          SuitFool: {
            header: 'Одномастка-дурак и Н-дурак',
            ...
            последний ход со счетом 1/2. В ином случае, при игре в Н-дурак, оба игрока заканчивают со счетом 0.',
          },
          WeightedSuitFool: {
            header: 'Взвешенные одномастка-дурак и Н-дурак',
            ...
            версии он получает 1/2, в Н-дураке - 0.',
          }
        }
      }
    }
